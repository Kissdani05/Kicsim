  ...
  return (
    <footer id="kapcsolat">
      ...
      <div className="footer-content">
        <div className="footer-section"><h3>MYMÁTRA VENDÉGHÁZ</h3><p>Kérdésed van? Vedd fel velünk bátran a kapcsolatot!</p><div className="footer-social"><a href="#" aria-label="Instagram"><i className="fab fa-instagram"/></a><a href="#" aria-label="Facebook"><i className="fab fa-facebook"/></a><a href="#" aria-label="Email"><i className="fas fa-envelope"/></a></div></div>
      ...
      <div className="footer-bottom"><p>&copy; 2024 MyMátra Vendégház. Minden jog fenntartva.</p><ul className="footer-bottom-links"><li><a href="#">Felhasználási feltételek</a></li><li><a href="#">Süti beállítások</a></li></ul></div>
    </footer>
  );
}
